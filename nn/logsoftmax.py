...
class LogSoftMax(Module):
    """don't know, why do we need this layer.
    ...
    def __init__(self):
        ...
        LogSoftMax.counter += 1
        self.name = "LogSoftMax_{}".format(LogSoftMax.counter)
    ...
    def update_grad_input(self,input_grad):
        return input_grad - self.S*np.sum(input_grad,axis=1,keepdims=True)
...
if __name__ == "__main__":
    ...
    print("running gradient check for LogSoftmax layer!")
